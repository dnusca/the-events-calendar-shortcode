  ...
  _createClass(SettingSelector, [{
    ...
    */
    value: function render() {
      ...
      var activeSettings = this.props.activeSettings; // Bail if no/still fetching activeSettings
      ...
      var selectedValue = setting ? setting : 'new-setting';
      var label = setting ? '' : __('Add new setting');
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(SelectControl, {
        label: label,
...
function (_Component) {
  ...
  function BlockEdit(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleAddSetting", function (setting) {
      ...
      _this.props.setAttributes(_defineProperty({}, setting, ''));
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSwitchSetting", function (setting, newSetting) {
      ...
      _this.props.setAttributes((_this$props$setAttrib2 = {}, _defineProperty(_this$props$setAttrib2, setting, undefined), _defineProperty(_this$props$setAttrib2, newSetting, ''), _this$props$setAttrib2));
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderSettingsTable", function () {
      ...
      settingsRender.push(React.createElement("tr", {
        key: 'new-setting'
      }, React.createElement("td", {
        width: '40%'
      }, React.createElement(_components_settingSelector__WEBPACK_IMPORTED_MODULE_0__["default"], _extends({
