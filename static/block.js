...
var KeyValueRepeater =
/*#__PURE__*/
function (_Component) {
  _inherits(KeyValueRepeater, _Component);

  function KeyValueRepeater(props) {
    var _this;

    _classCallCheck(this, KeyValueRepeater);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(KeyValueRepeater).call(this, props));

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "generateRows", function () {
      ...
      var existingSettings = Object.keys(keyValue).map(function (key) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h5", {
          key: key
        }, "".concat(key, ": ").concat(keyValue[key]));
      });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleAdd", function () {
      ...
      var newObject = Object.assign({}, keyValue, _defineProperty({}, currentKey, [currentValue]));
  ...
  _createClass(KeyValueRepeater, [{
    key: "render",
    value: function render() {
      var _this2 = this;

      var existingSettings = this.generateRows();
...
function (_Component) {
  ...
  _createClass(PastSetting, [{
    key: "render",
    value: function render() {
      var past = this.props.attributes.past;
...
function (_Component) {
  ...
  function BlockContainer() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(BlockContainer).apply(this, arguments));
  }
  ...
  _createClass(BlockContainer, [{
    ...
    value: function render() {
      ...
      return React.createElement(Fragment, null, isSelected ? React.createElement(_blockSettings__WEBPACK_IMPORTED_MODULE_1__["default"], this.props) : React.createElement(_blockPreview__WEBPACK_IMPORTED_MODULE_0__["default"], this.props));
    }
  }]);
...
function (_Component) {
  ...
  _createClass(BlockPreview, [{
    ...
    value: function render() {
      ...
      var propDisplay = Object.keys(attributes).map(function (key) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h5", {
          key: key
        }, "".concat(key, ": ").concat(attributes[key]));
      });
...
function (_Component) {
  ...
  function BlockEdit(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderSetting", function () {
      var settingsComponents = {
        category: React.createElement(_components_categorySetting__WEBPACK_IMPORTED_MODULE_0__["default"], _this.props),
        limit: React.createElement(_components_limitSetting_jsx__WEBPACK_IMPORTED_MODULE_1__["default"], _this.props),
        month: React.createElement(_components_monthSetting_jsx__WEBPACK_IMPORTED_MODULE_2__["default"], _this.props),
        past: React.createElement(_components_pastSetting_jsx__WEBPACK_IMPORTED_MODULE_3__["default"], _this.props),
        other: React.createElement(_components_keyValueRepeater_jsx__WEBPACK_IMPORTED_MODULE_4__["default"], _this.props)
      };
      return settingsComponents[_this.state.repeaterOption];
    });
