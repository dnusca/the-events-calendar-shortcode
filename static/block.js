...
function (_Component) {
  ...
  _createClass(DesignSetting, [{
    ...
    value: function render() {
      ...
      }, 'Upgrade'), __(' to Pro for more designs!')));
    }
  }]);
...
function (_Component) {
  ...
  function MonthSetting(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleTextChange", function (event) {
      _this.setState({
        valid: event.target.validity.patternMismatch
      });
    ...
    var valid = props.attributes.month === 'current';
    _this.state = {
      valid: valid
    };
    return _this;
  ...
  */
  ...
  _createClass(MonthSetting, [{
    ...
    value: function render() {
      ...
      var textValue = current ? '' : month;
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
        id: 'ecs-setting-month-current',
        type: 'checkbox',
        checked: current,
        onChange: this.handleChange
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, __('Current')), !current ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
        id: 'ecs-setting-month',
        style: {
          borderColor: this.state.valid ? 'red' : 'inherit'
        },
        type: 'text',
        placeholder: 'YYYY-MM',
        value: textValue,
  ...
  _createClass(PastSetting, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
        ...
        checked: past,
        onChange: this.handleChange
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, __('Show only past events?')));
    }
  }]);
...
function (_Component) {
  ...
  function BlockEdit() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSwitchSetting", function (setting, newSetting, keyValue) {
      ...
      _this.props.setAttributes((_this$props$setAttrib = {}, _defineProperty(_this$props$setAttrib, setting, undefined), _defineProperty(_this$props$setAttrib, "settings", JSON.stringify(newSettings)), _this$props$setAttrib));
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleRemoveSetting", function (setting, uid) {
      ...
      _this.props.setAttributes((_this$props$setAttrib2 = {}, _defineProperty(_this$props$setAttrib2, setting, undefined), _defineProperty(_this$props$setAttrib2, "settings", JSON.stringify(newSettings)), _this$props$setAttrib2));
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderSettingsTable", function () {
      ...
      var settingsRender = settings.map(function (setting) {
        ...
        }, _this.props)) : React.createElement("span", null, setting.charAt(0).toUpperCase() + setting.slice(1)); // Get the right component from our config
